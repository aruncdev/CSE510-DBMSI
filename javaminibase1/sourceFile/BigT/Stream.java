...
//					high_key = new StringKey(Util.padRightZeros(high_key1, 25) + ":" + Util.padLeftZeros(high_key2, 25));
					///////////////////////////////////////////////////////////////////////////
					if(low_key2!=null)
						low_key = new StringKey(Util.padRightZeros(low_key1, 25) + ":" + Util.padLeftZeros(low_key2, 25));
					else
...
//					high_key = new StringKey(Util.padRightZeros(high_key1, 25) + ":" + Util.padRightZeros(high_key2, 25));
					/////////////////////////////////////////////////////////////////////////
					if(low_key2!=null)
						low_key = new StringKey(Util.padRightZeros(low_key1, 25) + ":" + Util.padRightZeros(low_key2, 25));
					else
